...
import (
	...
	"github.com/rafabcanedo/FullCycleMicroServices/goapi/internal/entity"
)
...
// Function New Category recenendo a conexao do db
func NewCategoryDB(db *sql.DB) *CategoryDB {
	return &CategoryDB{db: db}
}

// defer in go = for exec him, all last commands have exec. After this, defer is exec.
// apend in go = get "category" and generate inside "categories" list.
